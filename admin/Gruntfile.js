...
var compiledtemplatepath = ["../watm/www/admin/public/js/templates.js"];
...
module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    copy: {
      main: {
        files: [
          ...
          {expand: true, flatten: true, src: templatepaths, dest: '../watm/www/admin/public/templates'},
    ...
    concat: {
      ...
      dist: {
        src: concatpaths,
        dest: '../watm/www/admin/public/js/main.js'
      }
    },
    ...
    compass: {
      development: {
        options: {
          sassDir: 'dev/sass',
          cssDir: '../watm/www/admin/public/css',
