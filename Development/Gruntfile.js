    ...
    copy: {
      main: {
        files: [
          ...
          {expand: true, flatten: true, src: templatepaths, dest: '../watm3.4/www/public/templates'},
        
          {expand: true, flatten: true, src: vendorpaths, dest: '../watm3.4/www/public/js/vendor'}
    ...
    uglify: {
      default: {
        ...
        files: {
          ...
          '../WeAppToMove/www/public/js/vendor.js': '../watm3.4/www/public/js/vendor.js'
